...
<body>
	...
	<div class="productenlijst">
		...
		<form action="cart.php" method="post">
			...
			{
				echo '
				<div class="product-container"  style="background: url(\''.$value["gameImage"].'\') no-repeat  center center ; background-size:cover">
				<div class="product-name">'.$value["gameTitle"].'</div>
				<div class="product-price">'.$value["gamePrice"].'</div>
				<div class="product-beschrijving"><input type="checkbox" id="order-button" name="selectedgameid[]" value="'.$value["gameId"].'" /></div>
